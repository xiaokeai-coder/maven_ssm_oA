				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_id" name="id" required=""
							placeholder="请输入消息编号 lay-verify="id" value="${myMessage.id }"
			...
			<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_tilte" name="title" required=""
							placeholder="请输入标题" value="${myMessage.title }" lay-verify="title" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="L_notice" class="layui-form-label"> 消息类型</label>
						...
						<c:if test="${myMessage.notice.id eq notice.id }">
						<input type="radio" name="notice.id" value="${notice.id }"
								title="${notice.type }"  checked="checked"/>
						</c:if>
						<c:if test="${myMessage.notice.id ne notice.id }">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_content" name="content" required=""
							placeholder="请输入内容"value="${myMessage.content }" lay-verify="content" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="show_time" name="show_time" required=""
							placeholder="请输入发布时间" value="${ myMessage.show_time}" lay-verify="show_time" autocomplete="off"
							class="layui-input">
					</div>
				</div>
